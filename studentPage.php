...
$stmt = $pdo->query("SELECT name FROM student where studentid = '{$studentid}'");
...
<button onclick="document.location='pt.php'" type="button" class="button">Test your personality now!</button>
</div>

<div class="col-lg-6 col-md-6">
  <p>The Big Five Personality Test</p>
  <img src="personality.jpg" alt="tradition" class="img-fluid">
  <button onclick="document.location='infoStud.php'" type="button" class="button">Information</button>
</div>
</div>
</div>
